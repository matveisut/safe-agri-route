...
- **Опционально (§10, эвристики):** признаки по MAVLink → fusion → при регистрации контекста миссии возможна кандидатная зона jammer и авто-replan (`telemetry_features`, `threat_fusion`, `mission_fusion_runtime`; см. `diplom/ТЗ.md` §10).
