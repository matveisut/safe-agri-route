...
**Согласование с ТЗ на ПО:** детали реализации платформы — в [`ТЗ.md`](ТЗ.md). Раздел **§10** описывает **целевую** модель динамического определения угрозы по нескольким источникам (GNSS, IMU, радиоканал, согласованность роя и др.) и слияния признаков; **полная** реализация этой модели **не входит** в минимальный объём подтверждения выполнения настоящего задания и может излагаться в перспективах ВКР и в [`knowledge/`](knowledge/).
